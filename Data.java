...
public class Data 
	{
      ...
      public static void addData(String n, String fn, String ln, String a1, String a2, String a3, String PPS, String sID, String c, String em)
		{
          char chn = n.charAt(0);
			int chInt = (int)chn;
      	int error =0;
              ...
              if(error==0)
				{
                  ...
                  JOptionPane.showMessageDialog(null, "The name has updated in the database : " + n);
                  error++;              
              }
          }
      ...
      public static void changeDetails(int position,String n, String fn, String ln, String a1, String a2, String a3, String PPS, String sID, String c, String em)
      {
    	  Contacts.get(i).name = n;
    	  Contacts.get(i).fName = fn;
    	  Contacts.get(i).lName = ln;
    	  Contacts.get(i).addr1 = a1;
    	  Contacts.get(i).addr2 = a2;
    	  Contacts.get(i).addr3 = a3;
    	  Contacts.get(i).PPSN = PPS;
    	  Contacts.get(i).StuID = sID;
    	  Contacts.get(i).contact = c;
    	  Contacts.get(i).emad = em;
      }
