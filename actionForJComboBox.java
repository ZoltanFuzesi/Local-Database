...
public class actionForJComboBox implements ActionListener
{
	 ...
	 public actionForJComboBox(JComboBox<String> combo)
	 {
		super();
		this.comboBox = combo;
 ...
 void setSuggestionModel(
  JComboBox<String> comboBox, ComboBoxModel<String> mdl, String str)
	...
	ComboBoxModel<String> getSuggestedModel(List<String> list, String text) 
	{
